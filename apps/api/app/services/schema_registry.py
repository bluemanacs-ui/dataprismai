...
class SchemaRegistry:
    ...
    def build_schema_context(self) -> str:
        ...
        lines += [
            ...
            "- Use ddm_* for conformed row-level lookups (richer than raw_*)",
            "- raw_* tables are raw source data — use only for specific record lookups",
            ...
            "- semantic_portfolio_kpis / dp_portfolio_kpis are best for executive-level KPIs",
        ]
        return "\n".join(lines)
