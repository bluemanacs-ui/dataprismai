...
const navItems = ["Saved Reports", "Metrics", "Datasets", "Skills", "Admin"];

export function Sidebar() {
  return (
    <aside className="hidden w-72 border-r border-zinc-800 bg-zinc-950 lg:flex lg:flex-col">
      <div className="p-4">
        <button className="w-full rounded-xl bg-blue-600 px-4 py-3 text-left text-sm font-medium text-white hover:bg-blue-500">
          + New Chat
        </button>
      </div>
